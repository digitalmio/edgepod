/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c edgepod/wrangler.json edgepod/.generated/cloudflare-env.d.ts` (hash: aa1dde2705696b1a2d09c7afe77eb3b6)
// Runtime types generated with workerd@1.20260507.1 2026-05-01 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./server");
    durableNamespaces: "EdgePodEngine";
  }
  interface Env {
    ASSETS: Fetcher;
    EDGEPOD_API_KEY: string;
    EDGEPOD_JWT_PRIVATE_KEY: string;
    EDGEPOD_DO: DurableObjectNamespace<import("./server").EdgePodEngine>;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "EDGEPOD_API_KEY" | "EDGEPOD_JWT_PRIVATE_KEY">
  > {}
}
